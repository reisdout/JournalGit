...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Test metrics on 10Mbps bottleneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Test metrics on 100Mbps bottleneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Test metrics on 500Mbps bottleneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Test metrics on 1000Mbps bottleneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Generalization metrics on 10Mbps bneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Generalization metrics on 100Mbps bneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Generalization metrics on 500Mbps bneck.}
...
\begin{minipage}{0.45\textwidth}
	...
	\begin{tiny}	
		...
		\end{tabular*}
		\vspace{-0.3cm}
		\captionof{table}{Generalization metrics on 1000Mbps bneck.}
